...
# place("Foil-Al", "cylinder", (0., 0., 124.5*cm), material= "aluminum", radius = 2.5*cm, length=100.0*um/2 )
# place("Foil-Al", "cylinder", (0., 0., 124.5*cm), material= "aluminum", radius = 2.5*cm, length=2.0*mm/2 )
...
make_beam_source("deuteron", 17.0, (0, 0., 0), (0, 0, 1), sigma_r = 3.0 * mm)
